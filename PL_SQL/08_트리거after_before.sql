...
CREATE TABLE tbl_user_backup(
    ...
    name VARCHAR2(20),
    address VARCHAR2(30),
    update_date DATE DEFAULT sysdate, -- 정보 변경 시간(기본값: INSERT되는 시간)
...
DECLARE
    v_type VARCHAR2(10);
BEGIN
    -- 현재 트리거가 발동된 상황이 UPDATE이지 DELETE 인지를 파악하는 조건문
...
VALUES('test04','메롱이','대전');

INSERT INTO tbl_user
VALUES('test05','김오라클','광주');
...
INSERT INTO product
VALUES (product_seq.NEXTVAL,'치킨',100,20000);
INSERT INTO product
VALUES (product_seq.NEXTVAL,'햄버거',10,5000);
...
BEGIN
    ...
    EXCEPTION 
        ...
        WHEN zero_total_exception THEN
            RAISE_APPLICATION_ERROR(-20002,'재고가 모두 소진되었습니다.');
END;
...
-- 트리거 내에서 예외가 발생하면 수행 중인 INSERT 작업은 중단되며 ROLLBACK이 진행 됩니다.
INSERT INTO order_history VALUES(order_history_seq.nextval,202,1,100,2000000);
